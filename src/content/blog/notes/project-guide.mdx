...
This guide offers a comprehensive look at the SkiCycleRun project architecture, including its use of AWS cloud services, authentication mechanisms, and development workflow. The site is designed as a modern static frontend powered by serverless backend services, delivering robust functionality and enhanced security.

## Table of contents

## Architecture Overview

SkiCycleRun is a hybrid static site built with Astro.js that leverages AWS cloud services for authentication, protected content, and data storage. The architecture follows modern JAMstack principles with serverless backend integration.
...
- **Protected Pages**: Require a valid JWT token via page-level wrappers
...
PUBLIC_COGNITO_DOMAIN=https://us-west-2uqzzy2hbw.auth.us-west-2.amazoncognito.com
...
- [Main Site Repository](https://github.com/timothyhalley/skicyclerun.com)
...
This guide provides a comprehensive overview of the SkiCycleRun.com architecture and development workflow. For specific implementation details, refer to the source code and AWS documentation.
